  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-200 to-gray-300">
      <div className="bg-white rounded-3xl shadow-2xl p-8 w-80">
        <h1 className="text-3xl font-extrabold mb-6 text-center text-gray-900 tracking-wide">
          Calculator
        </h1>
        <div className="mb-4">
          <input
        ...
        <button
          className="w-full py-3 mt-2 rounded-xl bg-gray-900 text-white text-xl font-bold shadow-md hover:bg-gray-800 transition-all duration-150"
          onClick={() => handleClick("=")}
        >
          =
        </button>
